...
import {
    ...
    CircularProgress
      ...
      const MembershipStatus = () => {
        ...
        const [user, setUser] = useState({ firstName: 'Yousef', email: 'yousef.henok@example.com' });
        const [isLoading, setIsLoading] = useState(false);
        const [formData, setFormData] = useState({
          fullName: 'Yousef Fatouraee', // here i am using mock full name
          email: 'yousef.henok@example.com', // mock email
          cardNumber: '', // As long as the card number is 16 digits, it will be accepted
          expiryDate: '', // As long as the expiry date is in the format MM/YY, it will be accepted
          cvv: ''
        });
        ...
        const handlePayment = async (e) => {
          ...
          try {
            // Here i am Simulating the payment processing here
            await new Promise(resolve => setTimeout(resolve, 2500)); // it will take 2.5 seconds to process the payment
            navigate('/home');
          } catch (error) {
            ...
            <Container maxWidth="md" sx={{ my: 4 }}>
              <Box className="welcome-section">
                ...
                <Typography variant="body1" className="welcome-message" gutterBottom>
                  Please pay your membership fee to benefit from all the exclusive access.
                </Typography>
              </Box>
